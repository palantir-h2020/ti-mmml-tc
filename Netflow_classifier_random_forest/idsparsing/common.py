...
wazuh_rule_id__to__threat_label_and_category[100029] = ('lockbit', 'ransomware')
wazuh_rule_id__to__threat_label_and_category[100015] = ('lockbit', 'ransomware')
wazuh_rule_id__to__threat_label_and_category[100030] = ('lockbit', 'ransomware')
wazuh_rule_id__to__threat_label_and_category[100032] = ('lockbit', 'ransomware')
wazuh_rule_id__to__threat_label_and_category[550] = ('malcolmQLF', 'ransomware') #ransomware.py
wazuh_rule_id__to__threat_label_and_category[7202] = ('arp-spoofing', 'arp-spoofing')
wazuh_rule_id__to__threat_label_and_category[7209] = ('arp-spoofing', 'arp-spoofing')
wazuh_rule_id__to__threat_label_and_category[31103] = ('sql_injection', 'sql_injection')
#wazuh_rule_id__to__threat_label_and_category[86601] = ('medicaldb', 'unauthorized_access')
# TODO!
